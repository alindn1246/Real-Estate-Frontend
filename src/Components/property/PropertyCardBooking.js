...
const PropertyCardBooking = ({ propertyId,trueDelete,dateTime}) => {
  ...
  const handleClickDelete = async () => {
    ...
    try {
      const response = await axios.delete(`https://localhost:7088/api/Book/DeleteByPropertyAndUser/${propertyId}/${userData.userId}`);
    ...
    <div className="card" >
      ...
      <div className="contents">
        ...
        {trueDelete && (
          ...
          <IoTrashBinOutline onClick={handleClickDelete} />
...
export default PropertyCardBooking;
